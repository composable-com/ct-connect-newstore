...
export type GetFunction<ResponseType> = (queryArgs: QueryArgs) => Promise<ResponseType>;

export type GetAllFunction<ResponseType> = (getFunction: GetFunction<ResponseType>) => GetFunction<ResponseType>;
